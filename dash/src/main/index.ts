...
// The driver display is 1600x600. In production (packaged build, Jetson)
// we run kiosk + fullscreen so a stray hand on the wheel can't kill the
// dash. In dev (`npm run dev`) we use a normal resizable window.
...
// On macOS dev, quit on close like a normal app. On the Jetson kiosk we
